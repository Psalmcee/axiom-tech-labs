...
import { Github, Linkedin, Mail, ExternalLink, Code2, Briefcase, User, ChevronDown, Menu, X, Facebook, Twitter, Instagram, Quote } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <Link to="/company" className="text-gray-300 hover:text-blue-600 transition-colors">
                  Company
                </Link>
            ...
            <>
              ...
              >
                <div className="max-w-4xl mx-auto text-center">
                  <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ color: '#b7feae' }}>
                    {'>_Hello Axiom'}
                  </h1>
                  ...
                  <div className="flex gap-4 justify-center mb-12">
                    <a href="https://github.com/Psalmcee" target="_blank" rel="noopener noreferrer" 
                      className="p-2 rounded-full bg-white text-gray-900 hover:bg-gray-200 transition-colors">
                      <Github size={24} />
                    </a>
                    <a href="https://www.linkedin.com/in/samuel-obidi-221628233" target="_blank" rel="noopener noreferrer"
                      className="p-2 rounded-full bg-white text-blue-600 hover:bg-gray-200 transition-colors">
                      <Linkedin size={24} />
                    </a>
                    <a href="mailto:samuelobidi8@gmail.com"
              ...
              {/* Projects Section */}
              <section className="py-20 px-4" id="projects" style={{ backgroundColor: '#b7feae' }}>
                      ...
                      <div key={project} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex gap-2">
                            <a href="#" className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-500">
                              <Github size={18} />
                              Code
                            </a>
                            <a href="#" className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-500 ml-4">
                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {[
                      ...
                      'TailwindCSS', 'PostgreSQL', 'Mongo DB', 'Docker'
                    ].map((skill) => (
              ...
              {/* About Section */}
              <section className="py-20 px-4 relative overflow-hidden" style={{ backgroundColor: '#7fffd4' }}>
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                  ...
                  <div className="prose prose-lg bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                    <p className="text-gray-600">
                      Axiom tech labs is a software development and consulting company. We produce and market software products, develop and host web-sites, and provide a wide range of consulting services to software development firms, corporate developers, other consultants, and clients ranging from the Fortune 100 to individuals. <br /> <br />
                      We firmly believe that Customer Satisfaction is the number one standard to which we all must be held. That belief is behind everything we do, from product development to customer support to our wide range of services.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="py-20 px-4 relative overflow-hidden" style={{ backgroundColor: '#98F5E1' }}>
                <div className="bubble bubble-1"></div>
                <div className="bubble bubble-2"></div>
                <div className="bubble bubble-3"></div>
                <div className="bubble bubble-4"></div>
        ...
        <footer className="bg-black text-gray-400 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li><Link to="/company" className="hover:text-blue-400 transition-colors">Our Story</Link></li>
                        <li><Link to="/company" className="hover:text-blue-400 transition-colors">Team</Link></li>
                        <li><Link to="/company" className="hover:text-blue-400 transition-colors">Careers</Link></li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-white font-semibold mb-4">FAQ</h3>
                      <ul className="space-y-2">
                        <li><Link to="/company" className="hover:text-blue-400 transition-colors">General</Link></li>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li><Link to="/contact" className="hover:text-blue-400 transition-colors">Support</Link></li>
                        <li><Link to="/contact" className="hover:text-blue-400 transition-colors">Sales</Link></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-1">
                <div className="bg-gray-900 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <a href="https://github.com/Psalmcee" className="flex items-center justify-center p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors">
                      <Github size={24} />
                    </a>
                    <a href="#" className="flex items-center justify-center p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors">
                      <Instagram size={24} />
                    </a>
                    <a href="#" className="flex items-center justify-center p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors">
                      <Facebook size={24} />
            ...
            <div className="mt-12 pt-8 border-t border-gray-800 text-center">
              <p>© {new Date().getFullYear()} Axiom Tech Labs. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
